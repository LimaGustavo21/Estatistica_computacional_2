...
```{r}
med_tend_maior <- replicate(10000, median(sim_fila(lambda_chegada = 60/60,
                                                lambda_atendimento = 30/60,
                                                tempo_expediente = 600)))
...
```{r}
max_tend_maior <- replicate(50000, max(sim_fila(lambda_chegada = 60/60,
                                                lambda_atendimento = 45/60,
                                                tempo_expediente = 600)))
...
```{r}
max_tend_maior <- replicate(10000, max(sim_fila(lambda_chegada = 60/60,
                                                lambda_atendimento = 20/60,
                                                tempo_expediente = 600)))
